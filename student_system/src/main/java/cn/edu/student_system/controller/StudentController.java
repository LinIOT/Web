...
public class StudentController {
    ...
    public GeneralResponse add(@RequestParam Integer id,@RequestParam String name,@RequestParam String password,@RequestParam String cla,@RequestParam String sex,@RequestParam String imgURL){
    ...
    public GeneralResponse update(@RequestParam String name,@RequestParam String password,@RequestParam String cla,@RequestParam String sex,@RequestParam String imgURL){
        Student student=new Student();
        student.setName(name);
        student.setPassword(password);
        student.setCla(cla);
