...
public class StudentDao {
    ...
    public int addStudent(Student student){
        return jdbcTemplate.update("INSERT INTO student(id,name,password,cla,sex) VALUES (?,?,?,?,?)",
                student.getId(),student.getStuName(),student.getPassword(),student.getCla(),student.getSex());
    }
    public int updateStudent(Student student){
        return  jdbcTemplate.update("UPDATE student SET stuName=?,password=?,cla=?,sex=? WHERE id=?",
                student.getStuName(),student.getPassword(),student.getCla(),student.getSex(),student.getId());
    }
